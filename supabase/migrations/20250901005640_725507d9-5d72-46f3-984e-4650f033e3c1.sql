...
-- Add autopilot settings to admin_settings without updated_by foreign key constraint
INSERT INTO public.admin_settings (setting_key, setting_value, updated_at)
VALUES 
  ('autopilot_enabled', 'true'::jsonb, now()),
  ('autopilot_frequency_minutes', '15'::jsonb, now())
...
VALUES 
  ('notification_templates', '{
    "freelancer_invited": {
      "email_subject": "You have been invited to a new project",
      "email_template": "freelancer_invited",
      "in_app_message": "You have been invited to {{project_title}} because your skills match the client needs."
    },
    "client_confirmation": {
      "email_subject": "Your project is being matched with experts", 
      "email_template": "client_confirmation",
      "in_app_message": "We have invited {{expert_count}} experts who match your requirements. Expect proposals within 48 hours."
    },
    "freelancer_reminder_48h": {
      "email_subject": "Reminder: Your project invitation is waiting",
      "email_template": "freelancer_reminder",
      "in_app_message": "You have been invited but have not responded. Please accept or decline so we can notify the client."
    },
    "client_reminder_72h": {
      "email_subject": "Still waiting for proposals",
      "email_template": "client_reminder", 
      "in_app_message": "No expert has submitted yet. We will extend invitations or suggest next steps."
    }
  }'::jsonb, now())
