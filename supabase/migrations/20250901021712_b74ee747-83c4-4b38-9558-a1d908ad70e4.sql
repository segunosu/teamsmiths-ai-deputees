...
-- Extend custom_project_milestones table for QA workflow (this table exists)
ALTER TABLE public.custom_project_milestones
...
-- Extend milestones table for QA workflow (this table also exists)
...
CREATE INDEX IF NOT EXISTS idx_custom_milestones_qa_status ON public.custom_project_milestones(qa_status);
CREATE INDEX IF NOT EXISTS idx_custom_milestones_payment_status ON public.custom_project_milestones(payment_status);
CREATE INDEX IF NOT EXISTS idx_milestones_qa_status ON public.milestones(qa_status);
CREATE INDEX IF NOT EXISTS idx_milestones_payment_status ON public.milestones(payment_status);