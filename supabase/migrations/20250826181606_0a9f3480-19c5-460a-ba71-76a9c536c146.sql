-- Create profiles for test freelancers with proper valid UUIDs
...
VALUES
  ...
  ('b2c3d4e5-f6a7-8901-bc23-de45fa678901'::uuid, 'James Chen', 'james.chen@example.com', false),
  ('c3d4e5f6-a7b8-9012-cd34-ef56ab789012'::uuid, 'Alex Rodriguez', 'alex.rodriguez@example.com', false)
ON CONFLICT (user_id) DO NOTHING;

-- Now create freelancer profiles with valid UUIDs
...
(
  'b2c3d4e5-f6a7-8901-bc23-de45fa678901'::uuid,
...
(
  'c3d4e5f6-a7b8-9012-cd34-ef56ab789012'::uuid,
