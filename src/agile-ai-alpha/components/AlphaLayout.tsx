...
import { LayoutDashboard, Building2, LineChart, Settings as SettingsIcon, Sparkles } from "lucide-react";
import { cn } from "@/lib/utils";

const NAV = [
  { to: "/agile-ai-alpha", label: "Dashboard", icon: LayoutDashboard, end: true },
