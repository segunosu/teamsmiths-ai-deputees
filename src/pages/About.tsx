        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="max-w-3xl mx-auto mb-12">
            <p className="text-lg leading-relaxed text-foreground/80 mb-6">
              We've helped startups and SMEs launch fast and scale efficiently, while driving measurable performance in large enterprises. As operators we served 25,000+ SMEs, onboarded 750 vendors, and generated $1.5M in 18 months — shipping MVPs with low-code to cut delivery costs by 55%+.
            </p>
