...
const Governance = () => {
  ...
  return (
    <>
      <Helmet>
        <title>The 4Ps AI Governance Framework | Teamsmiths · Compound business value with practical AI governance</title>
        <meta
          name="description"
          content="The 4Ps AI Governance Framework — Primed, Principled, Practised, Protected. Practical AI governance informed by team-performance and governance delivery at Haleon, GSK and Ogier Group. Run the free 4Ps assessment."
        />
        <meta
          name="keywords"
          ...
          <div className="max-w-7xl mx-auto relative">
            <div className="text-center">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-muted-foreground font-normal mb-8 max-w-3xl mx-auto leading-relaxed px-2">
                Compound business value with practical AI governance.
              </p>
