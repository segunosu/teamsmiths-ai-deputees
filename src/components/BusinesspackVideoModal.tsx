        ...
        <div className="bg-background rounded-xl shadow-2xl overflow-hidden">
          ...
          <div className="relative w-full aspect-[3/4] md:aspect-video bg-black">
            ...
            {showOverlay && (
              ...
              >
                <button
                  className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-white/90 hover:bg-white text-primary flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-2xl"
                  onClick={handleOverlayPlay}
                >
